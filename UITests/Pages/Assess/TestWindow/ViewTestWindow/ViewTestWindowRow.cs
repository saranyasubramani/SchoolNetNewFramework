...
{
    /// <summary>
    /// represents the view test window - search results grid row.
    /// </summary>
    public class ViewTestWindowRow : SNGridRow
    {
        /// <summary>
        /// the constructor
        /// </summary>
        ...
        public ViewTestWindowRow(string gridCssSelector, IWebElement webElement, int index, GridRowType type, List<SNGridColumn> columns, string overrideControlPrefix = null)
        ...
        private By ByTestWindowName { get { return GetColumnLocator(ViewTestWindowColumnNames.TestName); } }
        private WebElementWrapper TestWindowName { get; set; }
        private By BySubject { get { return GetColumnLocator(ViewTestWindowColumnNames.Subject); } }
        private WebElementWrapper Subject { get; set; }
        private By ByGrade { get { return GetColumnLocator(ViewTestWindowColumnNames.Grade); } }
        private WebElementWrapper Grade { get; set; }
        private By ByTestStage { get { return GetColumnLocator(ViewTestWindowColumnNames.TestStage); } }
        private WebElementWrapper TestStage { get; set; }
        private By ByStartDate { get { return GetColumnLocator(ViewTestWindowColumnNames.StartDate); } }
        private WebElementWrapper StartDate { get; set; }
        private By ByEndDate { get { return GetColumnLocator(ViewTestWindowColumnNames.EndDate); } }
        ...
        private By ByTestNameElement { get { return GetColumnLinkLocator(ViewTestWindowColumnNames.TestName); } }
        ...
        /// </summary>
        /// <returns></returns>
        public void SelectSelectLink()
        {
            Select.Wait(2).Click();
        }

        /// <summary>
        /// click on select test name link
        /// </summary>
        /// <returns></returns>
        public void SelectTestName()
        {
            TestNameElement.Wait(2).Click();
        }
    }
}
